  ...
  <div class="page-container">
    ...
    <van-popup v-model:show="showCitySearch" round position="bottom" style="height: 60%;">
      <div class="city-search-popup">
        <van-search v-model="citySearchInput" placeholder="请输入城市名称" show-action @cancel="showCitySearch = false" />
...
// 城市搜索（防抖）
const handleCitySearch = debounce(async (keyword: string) => {
  if (!keyword.trim()) {
...
// 监听输入变化，实时搜索
watch(citySearchInput, (newValue) => {
